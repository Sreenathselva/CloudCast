...
if(!weather) return;
    ...
    <>
        {createPortal(
            <div className="relative flex items-center gap-2 bg-foreground
            text-background w-fit rounded-md px-3 py-1.5 text-sm font-semibold
            text-balance drop-shadow-lg isolate">
                ...
                rotate-45 size-3 rounded-[3px] bg-foreground -z-10"></div>
            </div>,
            markerElement,
        )}
    </>
